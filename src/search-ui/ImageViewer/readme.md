...
4. 如果缩略图有裁剪，需要配置 imageClip（图片裁剪类型）属性。
...
<template>
    <div class="c-container">
        ...
        <div class="c-row-tile feature-toggle-wrapper">
            ...
            <label class="feature-toggle-label" @click="onChangeEasySwipe">翻页{{ easySwipe ? '' : '不' }}判断时间或角度</label>
        </div>

        <div class="c-row-tile feature-toggle-wrapper">
            <div class="feature-toggle" :class="{'state-checked': swipeDownDistance === 100}" @click="onChangeSwipeDownDistance">
                <div class="feature-toggle-bar-container">
                    <div class="feature-toggle-bar" />
                    <div class="feature-toggle-circle" />
                </div>
            </div>
            <label class="feature-toggle-label" @click="onChangeSwipeDownDistance">下拉退场改成{{ swipeDownDistance === 100 ? '默认' : '300px（3倍屏）' }}</label>
        </div>
    </div>
</template>
...
<script>
    module.exports = {
        methods: {
            ...
            onChangeSwipeDownDistance() {
                this.swipeDownDistance = 100 - this.swipeDownDistance;
            }
        }
    }
</script>
    ...
    <div class="c-container">
        <c-row>
            ...
            <c-span>
                ...
                <div class="img-wrapper c-gap-top" @click="onImgClick(9)">
                    <img :src="list[9].src">
                </div>
            </c-span>
        </c-row>
...
<script type="config">
    {
        data: {
            list: [
                ...
                {
                        src: "http://t7.baidu.com/it/u=1413424043,2613122925&fm=193",
                        width: 1600,
                        height: 2400,
                        desc: "d2006年，杨幂因出演金庸武侠剧《神雕侠侣》而崭露头角。2006年，杨幂因出演金庸武侠剧《神雕侠侣》而崭露头角。2006年，杨幂因出演金庸武侠剧《神雕侠侣》而崭露头角。"
                    },
                    {
                        src: "http://t8.baidu.com/it/u=3076583920,3293455465&fm=193",
                        width: 1600,
                        height: 2400,
                        desc: "e2006年，杨幂因出演金庸武侠剧《神雕侠侣》而崭露头角。2006年，杨幂因出演金庸武侠剧《神雕侠侣》而崭露头角。2006年，杨幂因出演金庸武侠剧《神雕侠侣》而崭露头角。"
                    },
                    {
                        src: "http://t9.baidu.com/it/u=1896758323,554720423&fm=193",
                        width: 1600,
                        height: 2400,
                        desc: "f2006年，杨幂因出演金庸武侠剧《神雕侠侣》而崭露头角。2006年，杨幂因出演金庸武侠剧《神雕侠侣》而崭露头角。2006年，杨幂因出演金庸武侠剧《神雕侠侣》而崭露头角。"
                    },
                    {
                        src: "http://t7.baidu.com/it/u=3162901241,99966225&fm=193",
                        width: 1600,
                        height: 2400,
                        desc: "g2006年，杨幂因出演金庸武侠剧《神雕侠侣》而崭露头角。2006年，杨幂因出演金庸武侠剧《神雕侠侣》而崭露头角。2006年，杨幂因出演金庸武侠剧《神雕侠侣》而崭露头角。"
                    },
                {
                    src: "https://ss1.bdstatic.com/70cFuXSh_Q1YnxGkpoWK1HF6hhy/it/u=1451090914,4273211459&fm=27&gp=0.jpg",
                    width: 800,
                ...
                },
                {
                    ...
                    width: 1600,
                    height: 1200,
                    desc: "a2006年，杨幂因出演金庸武侠剧《神雕侠侣》而崭露头角。"
                },
                {
                    src: "http://t7.baidu.com/it/u=2384973458,3021398817&fm=193",
                    width: 1600,
                    height: 2400,
                    desc: "b2006年，杨幂因出演金庸武侠剧《神雕侠侣》而崭露头角。2006年，杨幂因出演金庸武侠剧《神雕侠侣》而崭露头角。2006年，杨幂因出演金庸武侠剧《神雕侠侣》而崭露头角。"
                },
                {
                    src: "http://t7.baidu.com/it/u=698742162,2569883655&fm=193",
                    width: 1600,
                    height: 2400,
                    desc: "c2006年，杨幂因出演金庸武侠剧《神雕侠侣》而崭露头角。2006年，杨幂因出演金庸武侠剧《神雕侠侣》而崭露头角。2006年，杨幂因出演金庸武侠剧《神雕侠侣》而崭露头角。"
                }
            ],
            adGap: 10,
            adStartIndex: 4,
            adItems: [
                {
                    isAd: true,
                    adData: {
                        ad_place_data: '<div class="adddd">我是广告</div>',
                        ad_place_css: '.adddd {color: red}',
                        ad_place_js: 'var a = 1;'
                    }
                }
            ],
...
| adGap             | 广告出现的间隔数  |Number|15|否|
| adItems           | 广告数组  |Array|[]|否|
| adStartIndex      | 第几位开始出现广告  |Number|5|否|
| isSwipeFirstLeave | 左滑第一张图是否退场  |Boolean|false|否|
| imageClip         | 缩略图裁剪方式，0: 其他裁剪，1: 无裁剪，2: 居中裁剪，3: 顶部居中裁剪。     |Number|0|否|
| easySwipe         | 翻页条件只看滑动距离         |Boolean|false|否|
| swipeDuration     | 翻页动画时长                 |Number|380|否|
| swipeDownDistance | 下拉退场的距离条件            |Number|10|否|
| swipeEndOption    | 最后一张图右侧提示信息, isSwipeEnd: 最后一张图右侧是否有提示信息; maxSwipeEndDistance: 横滑最后一张图，图片移动距离大于此值时触发回调，此值最大为屏幕宽度的 1/2 |Object|isSwipeEnd: false, maxSwipeEndDistance: 0|否|
#### 其中 list 数组里对象的详细字段：
...
| updateAdItem  | 添加广告数据   |isAd: Boolean, adData: Object|@return undefine|
